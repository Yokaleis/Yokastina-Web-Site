        ...
        <div className="mx-auto px-2 sm:px-6 lg:px-8">
          ...
          <div className='flex h-16 items-center'>
            ...
            <div className="flex content-center m-auto sm:items-stretch sm:justify-start">
              <div className="hidden sm:ml-6 sm:block">
                <div className="flex space-x-4">
                  <Link to="/" className="lg:px-3 lg:py-2 lg:text-sm sm:px-1 sm:py-1 sm:text-xs">Incio</Link>
                  <Link to="/" id="proyectos" className="lg:px-3 lg:py-2 lg:text-sm sm:px-1 sm:py-1 sm:text-xs">Proyectos</Link>
